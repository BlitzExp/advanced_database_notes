-- ============================================================
-- Lesson 03 — Indexes: Setup + Class Exercises + Answers
-- Oracle 23ai / freesql.com
-- ============================================================
-- Note:
-- The original setup comment says 100,000 rows, but the INSERT uses:
-- CONNECT BY LEVEL <= 50000;
-- Therefore, this script inserts 50,000 rows unless that number is changed.
-- ============================================================

-- ============================================================
-- SETUP
-- Creates the patient_visits table and populates the data.
...
-- Insert sample data.
-- patient_id: 1–10,000, high cardinality.
-- site_id: 1–5, low cardinality.
...
-- Collect statistics so Oracle's optimizer has accurate information.
BEGIN
...
-- ============================================================
-- CLEANUP
-- Remove indexes created in these exercises.
-- Run this section only when you are done testing.
-- ============================================================

DROP INDEX idx_pv_patient_date;
DROP INDEX idx_pv_visit_date;

-- Optional cleanup if you created these optional test indexes:
